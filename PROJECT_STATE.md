...
- Current phase: persistent dark mode complete in source; ready for review and merge after the existing live release gates.
- Last completed prompt: add a premium, persistent light and dark theme toggle.
